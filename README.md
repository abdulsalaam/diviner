...
2. clone this project: `git clone git@github.com:kigichang/diviner.git`
3. go to folder **diviner/fixtures**
4. start fabric environment: `./start.sh`
...
- invoke:
    1. `peer chaincode invoke -o orderer.diviner.info:7050 --tls $CORE_PEER_TLS_ENABLED --cafile /opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/ordererOrganizations/diviner.info/orderers/orderer.diviner.info/msp/tlscacerts/tlsca.diviner.info-cert.pem -C divinerchannel -n lmsr -c '{"Args":[]}'`
- upgrade:
    1. `peer chaincode install -n lmsr -v 2.0 -p diviner/chaincode`
    2. `peer chaincode upgrade -o orderer.diviner.info:7050 --tls $CORE_PEER_TLS_ENABLED --cafile /opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/ordererOrganizations/diviner.info/orderers/orderer.diviner.info/msp/tlscacerts/tlsca.diviner.info-cert.pem -C divinerchannel -n lmsr -v 1.0 -c '{"Args":[]}'`
